...
throw new ApiError(400 , "Password is invalid")
    ...
    const {accessToken , refreshTken} = await generateAccessAndRefreshTokens(user._id)
...
const refreshAccessToken = asyncHandler(async(req , res) => {
    const incomingRefreshToken = req.cookies.refreshTken || req.body.refreshTken
    ...
    try {
        ...
        const {accessToken , refreshTken: newRefreshToken} = await generateAccessAndRefreshTokens(user._id)
        ...
        .json(
            new ApiResponse(
                200,
                {accessToken , refreshTken: newRefreshToken},
...
export { registeredUser , login , logoutUser , getCurrentUser , verifyEmail , resendEmailVerification , refreshAccessToken , forgotPasswordRequest , forgotPasswordRequest , changeCurrentPassword , resetForgotPassword};